...
// 将InPut里的公式传入
void MainWindow::Input() { ui->InPut->setText(expr.getExpression()); }

// 将结果显示在OutPut里
void MainWindow::Output() { ui->OutPut->setText(expr.getResult()); }
...
void MainWindow::updateHistory() {
  ui->History->setPlainText(expr.getExpression()
                                .append("\n")
                                .append(expr.getResult())
                                .append("\n")
                                .append("\n")
...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(ui->ButtonAdd, &QPushButton::clicked, this,
          [=]() { handleInput('+'); });
  connect(ui->ButtonSubtract, &QPushButton::clicked, this,
          [=]() { handleInput('-'); });
  connect(ui->ButtonMul, &QPushButton::clicked, this,
          [=]() { handleInput('*'); });
  ...
  connect(ui->ButtonAC, &QPushButton::clicked, this,
          [=]() { handleInput('x'); });
  connect(ui->ButtonDLE, &QPushButton::clicked, this,
          [=]() { handleInput('<'); });
  // 三角函数
  connect(ui->ButtonSin, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::SIN); });
  connect(ui->ButtonCos, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::COS); });
  connect(ui->ButtonTan, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::TAN); });
  connect(ui->ButtonAsin, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::ASIN); });
  connect(ui->ButtonAcos, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::ACOS); });
  // 平方开方
  connect(ui->ButtonSqrt, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::SQRT); });
  connect(ui->ButtonSqu, &QPushButton::clicked, this,
          [=]() { handleInput(Expression::Function::SQU); });
}
